...
are available to run a \JAGS\ model. See chapter~\ref{sec:R}
...
where $L$ and $U$ are integer arguments to the operator ``\textt{:}''. This
...
used on the right hand side of the relation defining \textt{mu} but
...
criticism (See section \ref{section:dic})

\chapter{Running JAGS from R}

\section{The rjags package}

\section{The runjags package}

\section{The jagsUI package}

\section{The dclone package}
...
file into this data table. See section \ref{sec:cmdline:data} for
